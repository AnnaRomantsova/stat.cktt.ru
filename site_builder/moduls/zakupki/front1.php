...
//echo $query;
 ...
 //конец ИТОГ
  ...
  while ($r->next_row()) {
        ...
        unset($sub);
        $sub = new outTree();
        $r->addFields($sub,$ar=array('id','contractMaxPrice','contractExecutionTerm_month','contractExecutionTerm_year','purchasePlacingTerm_year','purchasePlacingTerm_month','positionNumber','versionNumber','customer_fullName','purchaseFinCondition_amount','contractFinCondition','advance'));
